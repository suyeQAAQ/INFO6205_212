...
public class GA {
	...
	public static int P=5000;  //Population
	private static int bound=100;   //bound of the points
	public static ArrayList<Point> allpoints = generatePoints();;
	public static ArrayList<Point[]> popList = genePopulation();
	public static ArrayList<int[]> chromos = encode(popList);
	private static double breakPoint = 0.003;
...
//					}
	...
	public static ArrayList<int[]> encode(ArrayList<Point[]> pops){
	...
	public static void decode(ArrayList<int[]> chromos){
		for(int i=0;i<P;i++){
			int[] chromo = chromos.get(i);
